...
//	if(primaryParticle->GetDaughter() == 0) { // if the daughter is an optical photon
		analysisManager->FillNtupleDColumn(4, fEnergyAbs); // only then should the eAbs be filled
//	}
