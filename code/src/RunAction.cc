...
{ 
	...
	// Creating ntuple
	//
	G4cout << "About to creat ntuple...\n";
	analysisManager->CreateNtuple("file", "Data");
	G4cout << "Ntuple created...\n";
	...
	G4cout << "About to finish ntuple...\n";
	analysisManager->FinishNtuple();
	G4cout << "Ntuple finished...\n";
	
	
//	TTree tree("name","data");
	/*Int_t eventid;
